	...
	def execute(self):
        ...
        # Traffic Data Files for all Queries:
			...
			if(self.tableName == 'newColpvr_2016-01-01_366d_11rows'):
				...
				dtypes = { "Cosit":'int16', "LaneNumber":'int8',"LaneDescription":'category',"LaneDirection":'int8',"DirectionDescription":'category',"Volume":'float16',"Flags":'int8',"FlagText":'category',"AvgSpeed":'int32',"PmlHGV":'int16',"Class1Volume":'float16',"Class2Volume":'float16',"Class3Volume":'int8',"Class4Volume":'int8',"Class5Volume":'int8',"Class6Volume":'int8',"VolumeTimeliness_id":'int32'}
				...
				dtypes = {"Site_id":'int16',"Latitude":'float32',"Longitude":'float32'}
        ...
        # Numeric Data Files for all Queries:
			...
			if(self.tableName == 'newColpvr_2016-01-01_366d_11rows'):
				...
				dtypes = { "Cosit":'int16', "LaneNumber":'int8',"LaneDirection":'int8',"Volume":'float16',"Flags":'int8',"AvgSpeed":'int32',"PmlHGV":'int16',"Class1Volume":'float16',"Class2Volume":'float16',"Class3Volume":'int8',"Class4Volume":'int8',"Class5Volume":'int8',"Class6Volume":'int8',"VolumeTimeliness_id":'int32'}
			elif(self.tableName == 'TfGM_completeTuple_VolumeTimelinessQR_11rows'):
				nameAttributes = ["VolumeTimeliness_qid", "lastUpdateTime", "expiryTime", "deliveryTime", "age"]
				dtypes = {"VolumeTimeliness_qid":'int32',"age":'int8'}
			elif(self.tableName == 'testTrafficData_latlongInfo'):
        ...
        # Categorical Data Files for all Queries:
			...
			if(self.tableName == 'newColpvr_2016-01-01_366d_11rows'):
				...
				dtypes = { "Cosit":'int16',"LaneDirection":'category',"DirectionDescription":'category',"Volume":'category',"FlagText":'category',"AvgSpeed":'category',"Class3Volume":'category',"Class4Volume":'category',"Class5Volume":'category',"Class6Volume":'category',"VolumeTimeliness_id":'int32'}
			elif(self.tableName == 'TfGM_completeTuple_VolumeTimelinessQR_11rows'):
				nameAttributes = ["VolumeTimeliness_qid", "lastUpdateTime", "expiryTime", "deliveryTime", "age"]
				dtypes = {"VolumeTimeliness_qid":'int32',"age":'int8'}
			elif(self.tableName == 'testTrafficData_latlongInfo'):
